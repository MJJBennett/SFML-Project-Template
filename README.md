...
You'll need to download SFML (from [here](https://www.sfml-dev.org/download.php)) and extract/install it to lib/SFML-2.4.2/. Other names or locations can be used (including installation through a package manager) but this may require additional setup in the CMakeLists.txt file.

#### Building and running:

* To run this project, you will need a C++ compiler, CMake, and potentially Make, depending on your setup.

* In `build/`, run `cmake ..` (or `cmake .. -G "Generator Name"`, i.e. `cmake .. -G "MinGW Makefiles"` depending on what you want CMake to generate)
